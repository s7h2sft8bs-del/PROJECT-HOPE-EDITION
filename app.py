...
def home():
    ...
    # Video button - opens in popup style
    st.link_button("▶️ Watch: Meet Stephen (2 min)", "https://app.heygen.com/videos/10302438045d408cb992b38828e15d72", use_container_width=False)
